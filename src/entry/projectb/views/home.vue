<template>
  <div class="project-a-cxt-style">
    <el-page-header @back="goBack" content="多页projectB"></el-page-header>
    <div style="height: 20px"></div>
    <el-form ref="form" :model="form" label-width="80px">
      <el-form-item label="装货地址">
        <el-input placeholder="请入装货地址" v-model="form.goodStartAddress"></el-input>
      </el-form-item>
      <el-form-item label="卸货地址">
        <el-input placeholder="请入卸货地址" v-model="form.goodEndAddress"></el-input>
      </el-form-item>
...
import { getUserTokenMsg } from '../../../api/projectb';
export default {
  name: 'ProjectBHome',
  data() {
    return {

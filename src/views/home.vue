<template>
  <div class="project-a-cxt-style">
    <el-page-header @back="goBack" content="单页projectA"></el-page-header>
    ...
    <MyComponent v-model="carLengthAndThuckVisible" @callback="callback"></MyComponent>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    callback(res){
      ...
      this.form.carLengthAndThuck = res.length + '-' + res.type;
      console.log('this.form.carLengthAndThuck', this.form.carLengthAndThuck);
    }
  },
};
</script>
